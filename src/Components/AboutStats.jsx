    ...
    <div className="flex flex-col items-center">
      <div className="relative w-24 h-24 sm:w-32 sm:h-32">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span className="text-lg sm:text-2xl font-bold text-white">{count}%</span>
        </div>
      </div>
      <p className="text-xs sm:text-sm text-white mt-2 text-center max-w-xs">{label}</p>
    </div>
  );
};
...
const StatsSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-blue-50 to-blue-100">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Our Achievements</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative rounded-xl overflow-hidden shadow-xl min-h-[500px] sm:min-h-[600px] lg:min-h-[700px] order-2 lg:order-1">
            {/* Background Image */}
            <div 
            ...
            <div className="relative z-10 p-6 sm:p-8 space-y-6 mt-10 md:mt-72 sm:space-y-8 h-full flex flex-col justify-end pb-8 sm:pb-12">
              {/* Stats Grid */}
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                {stats.map((stat) => (
                  <div key={stat.id} className="text-center">
                    <div className={`text-2xl sm:text-3xl font-bold text-white ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}
                         style={{ animationDelay: `${stat.id * 0.1}s` }}>
                      {stat.value}
                    </div>
                    <p className="text-xs sm:text-sm text-blue-100 mt-1">{stat.label}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-4 sm:gap-8">
                <CircularProgress percentage={85} label="New Customers" />
          ...
          <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
            <div className={`bg-white p-4 sm:p-6 rounded-lg shadow-md ${isVisible ? 'animate-slide-in-right' : 'opacity-0'}`}
              ...
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-blue-600 text-lg sm:text-xl font-semibold">01</span>
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-900">Mission</h2>
              </div>
            ...
            <div className={`bg-white p-4 sm:p-6 rounded-lg shadow-md ${isVisible ? 'animate-slide-in-right' : 'opacity-0'}`}
              ...
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-blue-600 text-lg sm:text-xl font-semibold">02</span>
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-900">Vision</h2>
              </div>
              <p className="text-sm sm:text-base text-gray-700">
            ...
            <div className={`bg-white p-4 sm:p-6 rounded-lg shadow-md ${isVisible ? 'animate-slide-in-right' : 'opacity-0'}`}
              ...
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-blue-600 text-lg sm:text-xl font-semibold">03</span>
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-900">Values</h2>
              </div>
              <p className="text-sm sm:text-base text-gray-700">
